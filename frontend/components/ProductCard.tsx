    ...
    >
      ...
      <div className="flex min-w-0 flex-1 flex-col justify-between py-0.5">
        ...
        <div className="mt-2 flex items-end justify-between gap-2">
          ...
          <span className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full border border-[#e2e5dc] text-[#a4aa9e] transition-all group-hover:border-[#b8d16f] group-hover:bg-[#eff7d9] group-hover:text-[#4e6d19]"><ArrowUpRight className="h-3.5 w-3.5" aria-hidden /></span>
        </div>
      </div>
    </a>
  )
