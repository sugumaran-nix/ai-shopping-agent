...
export function ProductCard({ product, isLowestPrice = false, showSource = false }: { product: Product; isLowestPrice?: boolean; showSource?: boolean }) {
