...
export default function AIAnalysis({ analysis, query, total }: AIAnalysisProps) {
  ...
  // Convert markdown-like text to readable paragraphs
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ borderBottom: expanded ? "1px solid rgba(124,58,237,0.15)" : "none" }}
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs" style={{ color: "var(--text-secondary)" }}>
              {total} results found for &ldquo;{query}&rdquo;
            </p>
          </div>
        </div>
        {expanded
      ...
      {expanded && (
        ...
        >
          <div className="space-y-3">
            {lines.map((line, i) => {
              // Bold section headers (lines starting with numbers or all-caps)
